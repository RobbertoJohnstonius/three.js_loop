...
export function createAsset() {
    ...
    // ── Body / slide — 4×3×3 subdivisions → 144 tris ─────────────────────────
    let bodyGeo = new THREE.BoxGeometry(1.56, 0.42, 0.44, 4, 3, 3);
    ...
    // ── Gold ornamental rail — 6×2×2 subdivisions → 104 tris ────────────────
    let railGeo = new THREE.BoxGeometry(1.58, 0.12, 0.46, 6, 2, 2);
    ...
    // ── Grip — 3×6×3 subdivisions → 216 tris, GREEN dominant scale ──────────
    let gripGeo = new THREE.BoxGeometry(0.50, 0.64, 0.43, 3, 6, 3);
