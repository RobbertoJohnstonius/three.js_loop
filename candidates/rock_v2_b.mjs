...
export function createAsset() {
  ...
  // detail=3 → 320 tris.  Delete UV first so mergeVertices merges seam duplicates
  ...
  // Without UV: 164 unique indexed vertices, connectivity=1.0. With UV: 171, connectivity=0.974.
  ...
  // Radial displacement: ±10% of radius. Tapers toward poles to avoid apex spike.
  // Keep displacement ≤ ~50% of face edge length to prevent face inversion (visible splits).
  // detail=3 edge ≈ 0.26u → safe max ≈ 0.13u = 17.3% radius. ±10% is conservative and safe.
