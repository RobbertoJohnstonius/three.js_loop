...
export function createAsset() {
    ...
    // ── Gold ornamental rail — 6×1×1 subdivisions → 48 tris ────────────────
    let railGeo = new THREE.BoxGeometry(1.58, 0.12, 0.46, 6, 1, 1);
    ...
    // ── Grip — 3×6×3 subdivisions → 144 tris, GREEN dominant scale ──────────
