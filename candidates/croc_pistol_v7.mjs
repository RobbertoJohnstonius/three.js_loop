...
export function createAsset() {
    ...
    for (const _sx of _spineXs) {
        ...
        const _spMesh = new THREE.Mesh(_spGeo, new THREE.MeshStandardMaterial({
            color: 0xffffff, vertexColors: true, roughness: 0.10, metalness: 0.92, emissive: new THREE.Color(0.30, 0.22, 0.0), emissiveIntensity: 0.7 }));
        _spMesh.name = 'rail';
    ...
    const guardMesh = new THREE.Mesh(guardGeo, new THREE.MeshStandardMaterial({
        color: 0xffffff, vertexColors: true, roughness: 0.18, metalness: 0.72
